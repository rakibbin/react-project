...
export default function UpdateBlog() {
    ...
    useEffect(()=>{
        axios.get(`http://localhost/Node%20js/rakib5/Backend/blogs/getBlog.php?id=${id}`)
        .then((res)=>{
    ...
    const SaveBlog=()=>{
        ...
        axios.post("http://localhost/Node%20js/rakib5/Backend/blogs/updateBlog.php",formdata,{
            headers:{
    ...
    return (
        <div className="container">
            <h1 className="bg-info text-center text-bold">Update Blogs</h1>
