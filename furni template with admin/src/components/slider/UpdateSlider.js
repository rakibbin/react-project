...
export default function UpdateDesignation() {
    ...
    useEffect(() => {
        axios.get(`http://localhost/Node%20js/rakib5/Backend/testimonials/getSlider.php?id=${id}`)
            .then((res) => {
    ...
    const SaveDesignation = () => {
        ...
        axios.post("http://localhost/Node%20js/rakib5/Backend/testimonials/updateSlider.php", formdata, {
            headers: {
